<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AllSalons.aspx.cs" Inherits="AllSalons" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title> All Services of Salones admin </title>
...
<div class="container">
        ...
        <ul>
            ...
            <li><a href="Clinic page.aspx" style="font-weight: bold; font-family: 'times New Roman', Times, serif">Clinic Pages</a></li>
        ...
        <asp:GridView ShowHeaderWhenEmpyu="true" ID="gvPhoneBook" runat="server" AutoGenerateColumns="False" ShowFooter="True" DataKeyNames="PhoneBookID"  BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" OnRowCommand="gvPhoneBook_RowCommand" OnRowEditing="gvPhoneBook_RowEditing" OnRowCancelingEdit="gvPhoneBook_RowCancelingEdit" OnRowUpdating="gvPhoneBook_RowUpdating" OnRowDeleting="gvPhoneBook_RowDeleting" Height="168px" HorizontalAlign="Center" Width="918px">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Services of Salones">
                    ...
                    <FooterTemplate>
                   <asp:TextBox ID="txtlastFooter"  runat="server"  TextMode="MultiLine" />
                    </FooterTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Price of Services for Salones">
                    ...
                    <FooterTemplate>
                   <asp:TextBox ID="txtContactFooter"  runat="server" TextMode="MultiLine" />
                    </FooterTemplate>
                </asp:TemplateField>
